...
import * as sty from "./PlasmicHeaderButton.module.css"; // plasmic-import: QjUfVEq5Go/css
...
export const PlasmicHeaderButton__ArgProps = new Array<ArgPropType>("children");
...
function PlasmicHeaderButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <p.PlasmicSlot defaultContents={"Button text"} value={args.children} />
      </div>
    </div>
